...
const Anuncio = () => {
  ...
  const handleChange = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    selectedBrand ? setCarModel(cars[selectedBrand]) : "";
  };

  return (
    <div
      id={styles.createAnuncio}
      className="{showCreate ? '' : styles.hidden} "
    >
      <form onSubmit={handleSubmit(submit)}>
        ...
        <div className={styles.inputBox}>
          <label htmlFor="brand" className="heading-7-600">
            Marca
          </label>
          <select
            id="brand"
        ...
        <div className={styles.inputBox}>
          <label htmlFor="model" className="heading-7-600">
            Modelo
          </label>
          <select
        ...
        <div className={styles.inputBox}>
          <div className={styles.inputBoxContainer}>
            <div>
              <label htmlFor="year" className="heading-7-600">
                Ano
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="fuel" className="heading-7-600">
                Combustível
              </label>
              <input
                type="text"
        ...
        <div className={styles.inputBox}>
          <div className={styles.inputBoxContainer}>
            <div>
              <label htmlFor="mileage" className="heading-7-600">
                Quilometragem
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="color" className="heading-7-600">
                Cor
              </label>
              <input
                type="text"
        ...
        <div className={styles.inputBox}>
          <div className={styles.inputBoxContainer}>
            <div>
              <label htmlFor="fipe" className="heading-7-600">
                Preço tabela FIPE
              </label>
              <input
                type="text"
                ...
                data-tooltip-content={
                  errors.fipePrice ? errors.fipePrice.message : ""
                }
                data-tooltip-place="top"
                data-tooltip-float={true}
              />
            ...
            <div>
              <label htmlFor="price" className="heading-7-600">
                Preço
              </label>
              <input
                type="text"
        ...
        <div className={styles.inputBox}>
          <label htmlFor="description" className="heading-7-600">
            Descrição
          </label>
          <textarea
        ...
        <div className={styles.inputBox}>
          <label htmlFor="cover-image" className="heading-7-600">
            Imagem da capa
          </label>
          <input
            type="text"
        ...
        <div className={styles.inputBox}>
          <label htmlFor="galery-image" className="heading-7-600">
            Imagem da galeria
          </label>
          <input
            type="text"
            ...
            data-tooltip-content={
              errors.galeryImage ? errors.galeryImage.message : ""
            }
            data-tooltip-place="top"
            data-tooltip-float={true}
          />
        ...
        <button className={styles.addImages}>
          Adicionar campo para imagem da galeria
        </button>

        <div className={styles.buttonContainer}>
          <button className={styles.buttonMediumText} onClick={toggleFilters}>
            Cancelar
          </button>
          <button className={styles.buttonMediumText} type="submit">
            Criar anúncio
          </button>
        </div>
      </form>
